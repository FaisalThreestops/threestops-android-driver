...
public class BankNewAccountModel {
    ...
    {
        OkHttp3Connection.doOkHttp3Connection(token, ServiceUrl.ADD_DELETE_BANK_DETAILS, OkHttp3Connection.Request_type.POST, jsonObject, new OkHttp3Connection.OkHttp3RequestCallback() {
            @Override
