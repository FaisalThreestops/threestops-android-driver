...
public class ActionSheet extends Fragment implements OnClickListener {
    ...
    private View createView() {
        ...
        mPanel.setBackgroundColor(R.color.transparent);
    ...
    private void createItems() {
        ...
        params.bottomMargin = mAttrs.cancelButtonMarginBottom;
        mPanel.addView(bt, params);
    ...
    private Attributes readAttribute() {
        ...
        attrs.cancelButtonMarginBottom = (int) a.getDimension(R.styleable.ActionSheet_cancelButtonMarginBottom, attrs.cancelButtonMarginBottom);
    ...
    private static class Attributes {
        ...
        public Attributes(Context context) {
            ...
            this.cancelButtonBackground = new ColorDrawable(Color.GRAY);
            ...
            this.cancelButtonMarginBottom = 75;
